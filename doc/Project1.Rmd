...
# Wordcloud for male and female
par(mfrow = c(1,2))
wordcloud2(head(word_count_male,100), size = 0.8, rotateRatio = 0, gridSize = 1)
wordcloud2(head(word_count_female,100), size = 0.8, rotateRatio = 0, gridSize = 1)
```
